...
import { UnpostedEntry, isUnposted } from './UnpostedEntry'
  ...
  return (
    <Link href={`/shop/${product.slug}`} className="group block">
      ...
      <div>
        ...
        <p className="font-display text-xl text-dbb-cream mt-1 tabular-nums ledger-rule inline-block group-hover:[&::after]:border-dbb-credit group-hover:[&::before]:border-dbb-credit">
